...
import static com.example.yulia.chelseanewsapp.MainActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    private static List<Item> extractItemFromJson(String Newsjson){
        ...
        try {
            ...
            JSONObject newBaseJsonResponse = baseJsonObject.getJSONObject("response");
            JSONArray results = newBaseJsonResponse.getJSONArray("results");
            ...
            for(int i=0; i < results.length(); i++ ){
                ...
                JSONObject fields = currentItem.getJSONObject("fields");
    ...
    /**
     * Query the USGS dataset and return a list of {@link Item} objects.
     */
    public static List<Item> fetchNewsData(String requestUrl) {
        ...
        List<Item> earthquakes = extractItemFromJson(jsonResponse);
